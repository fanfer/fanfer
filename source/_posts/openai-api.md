---
title: OpenAI-API-中文版
date: 2023-10-18 10:24:40
tags:
    - 笔记
    - LLM
categories:
...
## 一. [Introduction](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fintroduction) 介绍

如果你想使用我们的API，你可以通过 **HTTP** 请求从任何语言与 API 进行交互，也可以使用我们的官方 Python 绑定、官方 Node.js库 或 **[社区维护的库](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Flibraries%2Fcommunity-libraries)**。
...
## 二. [Authentication](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fauthentication) 认证

### 1. OpenAI-API-KEY

**OpenAI API** 使用 API密钥 进行身份验证。请访问您的 **[API密钥](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Faccount%2Fapi-keys)** 页面以检索您在请求中使用的API密钥。
...
可以在 **[组织设置](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Faccount%2Forg-settings)** 页面上找到 **组织ID**

## 三. [Making requests](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fmaking-requests) 提出请求
...
现在您已经生成了第一个聊天完成。我们可以看到 `finish_reason` 是 `stop`，这意味着API返回了模型生成的完整完成。在上面的请求中，我们只生成了一条消息，但您可以将 `n` 参数设置为生成多个消息选项。在此示例中，`gpt-3.5-turbo` 被用于更传统的 [文本完成任务](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fguides%2Fcompletion%2Fintroduction)。该模型也针对 [聊天应用](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fguides%2Fchat) 进行了优化。

## 四. [Models](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fmodels) 模型
...
### 1. [List models](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fmodels%2Flist) 列出模型
...
### 2. [Retrieve model](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fmodels%2Fretrieve) 检索模型
...
## 五. [Completions](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fcompletions) 完成

给定一个提示，模型将返回一个或多个预测的完成，并且还可以在每个位置返回替代令牌的概率。

### 1. [Create completion](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fcompletions%2Fcreate)
...
> 
> `logprobs` 的最大值为 5。如果您需要更多，请通过我们的 [帮助中心](https://link.juejin.cn/?target=https%3A%2F%2Fhelp.openai.com%2Fen%2F) 联系我们并描述您的用例。
> 
...
## 六. [Chat](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fchat) 聊天

给定一组描述对话的消息列表，模型将返回一个回复。

### 1. [Create chat completion](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fchat%2Fcreate)
...
## 七. [Edits](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fedits) 编辑

给定一个提示和一条指令，模型将返回提示的编辑版本。

### 1. [Create edit](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fedits%2Fcreate)
...
## 八. [Images](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fimages) 图像
...
### 1. [Create image](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fimages%2Fcreate)
...
### 2. [Create image edit](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fimages%2Fcreate-edit)
...
### 3. [Create image variation](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fimages%2Fcreate-variation)
...
## 九. [Embeddings](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fembeddings) 嵌入
...
## 十. [Audio](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Faudio) 音频

了解如何将音频转换为文本。

相关指南：[语音转文本](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fguides%2Fspeech-to-text)

### 1. [Create transcription](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Faudio%2Fcreate)
...
• **`prompt` （string，选填）**
一个可选的文本，用于指导模型的风格或继续之前的音频片段。 [prompt](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fguides%2Fspeech-to-text%2Fprompting) 应该与音频语言相匹配。
• **`response_format` （string，选填，Defaults to json）**
转录输出的格式，可选项包括：json、文本、srt、verbose_json或vtt。
• **`temperature` （number，选填，Defaults to 0）**
采样温度介于0和1之间。较高的值（如0.8）会使输出更随机，而较低的值（如0.2）则会使其更加集中和确定性。如果设置为0，则模型将使用 [log probability(对数概率)](https://link.juejin.cn/?target=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FLog_probability) 自动增加温度，直到达到某些阈值。
• **`language` （string，选填）**
输入音频的语言。以 [ISO-639-1](https://link.juejin.cn/?target=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FList_of_ISO_639-1_codes) 格式提供输入语言将提高准确性和延迟。

### 2. [Create translation](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Faudio%2Fcreate)
...
## 十一. [Files](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffiles) 文件
...
### 1. [List files](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffiles%2Flist)
...
### 2. [Upload file](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffiles%2Fupload)
...
### 3. [Delete file](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffiles%2Fdelete)
...
### 4. [Retrieve file](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffiles%2Fretrieve)
...
### 5. [Retrieve file content](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffiles%2Fretrieve-content)
...
## 十二. [Fine-tunes](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffine-tunes) 微调
...
### 1. [Create fine-tune](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffine-tunes%2Fcreate)
...
### 2. [List fine-tunes](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffine-tunes%2Flist)
...
### 3. [Retrieve fine-tune](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffine-tunes%2Fretrieve).
...
[了解更多关于微调的内容](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fguides%2Ffine-tuning)。
...
### 4. [Cancel fine-tune](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffine-tunes%2Fcancel)
...
### 5. [List fine-tune events](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffine-tunes%2Fevents)
...
> 是否对微调作业进行事件流。
> 
> 如果设置为 true，则事件将作为数据 [服务器发送的事件](https://link.juejin.cn/?target=https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FAPI%2FServer-sent_events%2FUsing_server-sent_events%23event_stream_format) 随时可用。当作业完成（成功、取消或失败）时，流将以 `data：[DONE]` 消息终止。
> 
> 如果设置为 false，则仅返回到目前为止生成的事件。
> 

### 6. [Delete fine-tune model](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Ffine-tunes%2Fdelete-model)
...
## 十三. [Moderations](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fmoderations) 审核

给定一个输入文本，输出模型是否将其分类为违反 OpenAI 内容政策。

相关指南：[Moderations](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fguides%2Fmoderation)

### 1. [Create moderation](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fmoderations%2Fcreate)
...
## 十五. [Parameter details](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fparameter-details) 参数细节

**频率和存在惩罚**

在 [Completions API](https://link.juejin.cn/?target=https%3A%2F%2Fplatform.openai.com%2Fdocs%2Fapi-reference%2Fcompletions) 中发现的频率和存在惩罚可以用于减少采样重复令牌序列的可能性。它们通过直接向 logits（未归一化的对数概率）添加贡献来进行修改。
